...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Title', true), array('action' => 'edit', $title['Title']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Title', true), array('action' => 'delete', $title['Title']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $title['Title']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($title['BillingAddress'])):?>
	...
	<?php
		$i = 0;
		foreach ($title['BillingAddress'] as $billingAddress):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
...
<div class="related">
	...
	<?php if (!empty($title['CartBillingAddress'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Id'); ?></th>
		<th><?php __('First Name'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($title['CartBillingAddress'] as $cartBillingAddress):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
